    ...
    <section id="contact" className="bg-color-900 py-12 px-6 md:px-12 lg:px-24">
        ...
        <motion.div
         ...
         className="flex items-center justify-center gap-6 pt-8">
            ...
            <a href="https://www.linkedin.com/in/elon-jiel-tumbokon-334952188" className="text-blue-500 hover:underline">
              <AiFillLinkedin size={32} />
            </a>
            <a href="https://github.com/elonjiel" className="text-blue-500 hover:underline">
